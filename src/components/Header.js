  ...
  return (
    <header className="text-gray-600 body-font shadow-lg">
      <div className="container cursor-pointer mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <button className="inline-flex items-center text-white bg-green-500 border-0 py-2 px-4 focus:outline-none hover:bg-green-700 rounded text-base mt-4 md:mt-0">
          Go to Cart
          <svg
            fill="none"
            stroke="currentColor"
